...
async def get_char_args(msg: str, uid: str) -> Union[Tuple[Dict, Optional[str], Optional[int], Optional[int]], str]:
    # 可能进来的值
...
async def get_fake_char_data(char_data: Dict, fake_name: str, uid: str) -> Union[Dict, str]:
