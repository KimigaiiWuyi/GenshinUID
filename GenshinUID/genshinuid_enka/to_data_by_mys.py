...
async def mys_to_data(uid: str, force_refresh: bool = False):
    ...
    for char in data:
        ...
        all_prop = char["base_properties"] + char["extra_properties"] + char["element_properties"]
        ...
        for prop in all_prop:
            ...
            if prop_id == 2000:
                ...
                avatar_fight_prop["elementalMastery"] = get_value(prop["final"])
            elif prop_id == 20:
                ...
                avatar_fight_prop["physicalDmgBonus"] = get_value(prop["final"])
