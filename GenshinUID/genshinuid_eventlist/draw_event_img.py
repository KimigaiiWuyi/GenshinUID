...
class DrawEventList:
    ...
    async def get_event_data(self):
        ...
        for event in event_list:
            ...
            if desc_content and desc_content[0] and len(desc_content[0]) > 2 and desc_content[0][2]:
    ...
    async def get_and_save_event_img(self):
        ...
        for index, value in enumerate(self.normal_event):
            ...
            banner_img = banner_img.resize((576, 208), Image.Resampling.LANCZOS)
            ...
            # 画三角
            event_img_draw.polygon([(98, 211), (98, 237), (121, 224)], fill=(243, 110, 110))
    ...
    async def get_and_save_gacha_img(self):
        ...
        for index, value in enumerate(self.gacha_event):
            ...
            banner_img = Image.open(BytesIO(get(value["banner"]).content))
            banner_img = banner_img.resize((576, 284), Image.Resampling.LANCZOS)
            ...
            # 画三角
            gacha_img_draw.polygon([(98, 261), (98, 287), (121, 274)], fill=(243, 110, 110))
