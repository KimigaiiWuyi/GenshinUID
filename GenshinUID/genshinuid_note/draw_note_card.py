...
async def draw_note_img(uid: str, ev: Event) -> Union[bytes, str]:
    ...
    # 本月比上月 原石
    month_stone_percent = month_stone / lastmonth_stone if lastmonth_stone != 0 else 1
    month_stone_percent = month_stone_percent if month_stone_percent <= 1 else 1
    # 本月比上月 摩拉
    month_mora_percent = month_mora / lastmonth_mora if lastmonth_mora != 0 else 1
    ...
    img_draw.text((245, 923), lastday_stone_str, second_color, gs_font_26, "mm")
    img_draw.text((621, 923), lastday_mora_str, second_color, gs_font_26, "mm")
    img_draw.text((245, 1396), lastmonth_stone_str, second_color, gs_font_26, "mm")
    img_draw.text((621, 1396), lastmonth_mora_str, second_color, gs_font_26, "mm")
