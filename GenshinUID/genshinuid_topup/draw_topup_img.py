    ...
    if type == "支付宝":
        ...
        drawer.text(
            (
                ...
                int(70 - warning + (30 - gs_font_25.getbbox(item_info)[-1]) / 2),
            ),
            item_info,
            fill="#000000",
            font=gs_font_25,
        ...
        drawer.text(
            (
                ...
                int(105 - warning + (30 - gs_font_25.getbbox(item_price)[-1]) / 2),
            ),
            item_price,
            fill="#000000",
            font=gs_font_25,
        ...
        drawer.text(
            (
                ...
                int(155 + warning + (20 - gs_font_15.getbbox(f"充值到 UID{uid}")[-1]) / 2),
            ),
            f"充值到 UID{uid}",
            fill="#333333",
            font=gs_font_15,
        ...
        drawer.text(
            (
                ...
                int(50 - warning + (30 - gs_font_25.getbbox(item_info)[-1]) / 2),
            ),
            item_info,
            fill="#000000",
            font=gs_font_25,
        ...
        drawer.text(
            (
                ...
                int(80 - warning + (30 - gs_font_25.getbbox(item_price)[-1]) / 2),
            ),
            item_price,
            fill="#000000",
            font=gs_font_25,
        ...
        drawer.text(
            (
                ...
                int(120 - warning + (20 - gs_font_15.getbbox(f"充值到 UID{uid}")[-1]) / 2),
            ),
            f"充值到 UID{uid}",
            fill="#333333",
            font=gs_font_15,
