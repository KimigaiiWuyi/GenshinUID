...
from ..utils.xk_api.get_xk_data import get_abyss_total
...
async def draw_xk_abyss_img():
    raw_data = await get_abyss_total()
    last_time: str = raw_data['modify_time']  # 2022-11-23 00:06
    version_desc = raw_data['schedule_version_desc']  # 3.2第一期
    total_view: Dict[str, str] = raw_data['abyss_total_view']
    last_rate: Dict[str, str] = raw_data['last_rate']
    char_use_list: List[Dict] = raw_data['character_used_list']
