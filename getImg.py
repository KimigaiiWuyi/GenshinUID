...
async def draw_abyss0_pic(uid,nickname,image = None,mode = 2,date = "1"):
    ...
    for j in range(0,len(floors_data["levels"])):
        ...
        abyss2_text_draw.text((87,30),f"第{j+1}间", new_color, ys_font(21))
        ...
        abyss2_text_draw.text((167,33), f"{otherStyleTime1}/{otherStyleTime2}", new_color, ys_font(19))
    ...
    text_draw.text((690, 82),raw_data['max_floor'], new_color, ys_font(26))
    text_draw.text((690, 127),str(raw_data['total_battle_times']), new_color, ys_font(26))
    text_draw.text((690, 172),str(raw_data['total_star']), new_color, ys_font(26))
...
async def draw_abyss_pic(uid,nickname,floor_num,image = None,mode = 2,date = "1"):
    ...
    text_draw.text((220,163), f"{nickname}", new_color, ys_font(32))
    text_draw.text((235, 203), 'UID ' + f"{uid}", new_color, ys_font(14))
    text_draw.text((710, 190), f"{floor_num}", new_color, ys_font(50),anchor="mm")
