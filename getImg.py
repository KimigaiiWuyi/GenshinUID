...
from .getDB import GetInfo, GetCharacter, GetSpiralAbyssInfo, GetMysInfo, errorDB, cacheDB, GetGenshinEvent
...
async def draw_abyss0_pic(uid, nickname, image=None, mode=2, date="1"):
    ...
    for i in range(0, 4):
        if not os.path.exists(os.path.join(CHAR_DONE_PATH, str(raw_data["reveal_rank"][i]["avatar_id"]) + ".png")):
            get_chardone_pic(raw_data["reveal_rank"][i]["avatar_id"], raw_data["reveal_rank"][i]["avatar_icon"],
        ...
        for k in raw_char_data:
            if k['id'] == raw_data["reveal_rank"][i]["avatar_id"]:
                char_draw.text((63.5, 117), f'{str(raw_data["reveal_rank"][i]["value"])}次', (21, 21, 21), ys_font(18),
                               anchor="mm")
    ...
    for i in range(0, 1):
        if not os.path.exists(os.path.join(CHAR_DONE_PATH, str(raw_data["damage_rank"][i]["avatar_id"]) + ".png")):
            get_chardone_pic(raw_data["damage_rank"][i]["avatar_id"], raw_data["damage_rank"][i]["avatar_icon"],
                             raw_data["reveal_rank"][i]["rarity"])
        ...
        for k in raw_char_data:
            if k['id'] == raw_data["damage_rank"][i]["avatar_id"]:
                char_draw.text((63.5, 117), f'{str(raw_data["damage_rank"][i]["value"])}', (21, 21, 21), ys_font(18),
                               anchor="mm")
                char_draw.text((95.3, 19), f'{str(k["actived_constellation_num"])}', 'white', ys_font(18))
                if str(k["fetter"]) == "10" or str(k["name"]) == "旅行者":
                    char_draw.text((93, 41.5), "♥", (21, 21, 21), ys_font(15))
    ...
    for i in range(0, 1):
        if not os.path.exists(os.path.join(CHAR_DONE_PATH, str(raw_data["defeat_rank"][i]["avatar_id"]) + ".png")):
            get_chardone_pic(raw_data["defeat_rank"][i]["avatar_id"], raw_data["defeat_rank"][i]["avatar_icon"],
                             raw_data["reveal_rank"][i]["rarity"])
        ...
        for k in raw_char_data:
            if k['id'] == raw_data["defeat_rank"][i]["avatar_id"]:
                char_draw.text((63.5, 117), f'{str(raw_data["defeat_rank"][i]["value"])}', (21, 21, 21), ys_font(18),
                               anchor="mm")
                char_draw.text((95.3, 19), f'{str(k["actived_constellation_num"])}', 'white', ys_font(18))
                if str(k["fetter"]) == "10" or str(k["name"]) == "旅行者":
                    char_draw.text((93, 41.5), "♥", (21, 21, 21), ys_font(15))
    ...
    for i in range(0, 1):
        if not os.path.exists(os.path.join(CHAR_DONE_PATH, str(raw_data["take_damage_rank"][i]["avatar_id"]) + ".png")):
            get_chardone_pic(raw_data["take_damage_rank"][i]["avatar_id"],
    ...
    for i in range(0, 1):
        if not os.path.exists(
            ...
            get_chardone_pic(raw_data["normal_skill_rank"][i]["avatar_id"],
    ...
    for i in range(0, 1):
        if not os.path.exists(
            ...
            get_chardone_pic(raw_data["energy_skill_rank"][i]["avatar_id"],
